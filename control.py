...
for i, edge_list in enumerate(edge_lists):
	...
	n.stimulate(0,0, record_nuerons[i], 100, names[i]+"_control_activation", "Nueron Activation")
	plt.clf()
	n.spike_times(0,0, 100, names[i]+"_control_spike_times", "Nueron Spike Times", plot=True)
	plt.clf()
